...
def ODIN(inputs, outputs, model, temper, noiseMagnitude1):
    '''
     data: image features
     output: feed image into network then can get output
     net: neural network
     T: a hyperparaeter usually seted equal 1 / number of classes
     noise: type=float, default=0, help='noise for Odin'
